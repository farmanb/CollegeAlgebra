...
},
{
  "id": "objectives-16",
  "level": "2",
  "url": "sec-linear_functions.html#objectives-16",
  "type": "Objectives",
  "number": "3.1",
  "title": "",
...
},
{
  "id": "example-30",
  "level": "2",
  "url": "sec-linear_functions.html#example-30",
  "type": "Example",
  "number": "3.1.5",
  "title": "",
...
},
{
  "id": "exercise-18",
  "level": "2",
  "url": "sec-linear_functions.html#exercise-18",
  "type": "Worksheet Exercise",
  "number": "3.1.3.1",
  "title": "",
...
},
{
  "id": "exercise-19",
  "level": "2",
  "url": "sec-linear_functions.html#exercise-19",
  "type": "Worksheet Exercise",
  "number": "3.1.3.2",
  "title": "",
  "body": "Determine whether the equation represents a linear function of in terms of . If so, express the equation in the form . Otherwise, explain why the equation does not represent a linear function. "
},
{
  "id": "exercise-20",
  "level": "2",
  "url": "sec-linear_functions.html#exercise-20",
  "type": "Worksheet Exercise",
  "number": "3.1.3.3",
  "title": "",
...
},
{
  "id": "exercise-21",
  "level": "2",
  "url": "sec-linear_functions.html#exercise-21",
  "type": "Worksheet Exercise",
  "number": "3.1.3.4",
  "title": "",
...
},
{
  "id": "objectives-18",
  "level": "2",
  "url": "sec-lines.html#objectives-18",
  "type": "Objectives",
  "number": "3.2",
  "title": "",
...
},
{
  "id": "exercise-26",
  "level": "2",
  "url": "sec-lines.html#exercise-26",
  "type": "Worksheet Exercise",
  "number": "3.2.4.5",
  "title": "",
...
},
{
  "id": "exercise-27",
  "level": "2",
  "url": "sec-lines.html#exercise-27",
  "type": "Worksheet Exercise",
  "number": "3.2.4.6",
  "title": "",
...
},
{
  "id": "objectives-20",
  "level": "2",
  "url": "sec-perp_parallel.html#objectives-20",
  "type": "Objectives",
  "number": "3.3",
  "title": "",
...
},
{
  "id": "example-40",
  "level": "2",
  "url": "sec-perp_parallel.html#example-40",
  "type": "Example",
  "number": "3.3.10",
  "title": "",
...
},
{
  "id": "exercise-29",
  "level": "2",
  "url": "sec-perp_parallel.html#exercise-29",
  "type": "Worksheet Exercise",
  "number": "3.3.2",
  "title": "",
...
},
{
  "id": "exercise-30",
  "level": "2",
  "url": "sec-perp_parallel.html#exercise-30",
  "type": "Worksheet Exercise",
  "number": "3.3.3",
  "title": "",
...
},
{
  "id": "objectives-22",
  "level": "2",
  "url": "sec-linear_ineq.html#objectives-22",
  "type": "Objectives",
  "number": "3.4",
  "title": "",
...
},
{
  "id": "example-48",
  "level": "2",
  "url": "sec-linear_ineq.html#example-48",
  "type": "Example",
  "number": "3.4.20",
  "title": "",
  "body": "  Graph the linear absolute value inequality .    The solutions to the inequality are the points that are solutions to either the linear inequality or the linear inequality This means the graph is the combination of the graphs for the linear inequalities That is, the points that are either on or above the line , or on or below the line .      The graph of the linear absolute value inequality .    "
},
{
  "id": "objectives-23",
  "level": "2",
  "url": "sec-linear_ineq.html#objectives-23",
  "type": "Objectives",
  "number": "3.4.2",
  "title": "",
  "body": "  Graph linear inequalities.  Graph linear absolute value inequalities.   "
...
},
{
  "id": "exercise-34",
  "level": "2",
  "url": "sec-linear_ineq.html#exercise-34",
  "type": "Worksheet Exercise",
  "number": "3.4.2.4",
  "title": "",
...
},
{
  "id": "exercise-35",
  "level": "2",
  "url": "sec-linear_ineq.html#exercise-35",
  "type": "Worksheet Exercise",
  "number": "3.4.2.5",
  "title": "",
  "body": "Graph the linear absolute value inequality . "
},
{
  ...
  "body": " Forms of Quadratic Functions    Place a quadratic function in vertex form,  Find the vertex of a quadratic function,     In this section, we study a polynomial functions of degree 2. These polynomial functions are often called quadratic function .    Quadratic Function  A function is quadratic   Function  Quadratic  if it has the form where , , and are numbers, and .    Vertex Form  Just as with lines, quadratic functions are easier to understand through visualizations. While general quadratics are slightly more complicated, we can already handle quadratics in the following form.   The Vertex Form of a Quadratic  A quadratic function, , is in vertex form   Function  Quadratic  Vertex Form  if there are numbers and such that    The methods of tell us how to graph a quadratic in vertex form using . We call the graph of a parabola   Graph  Parabola  and the point the vertex   Graph  Parabola  Vertex  of the parabola.  To graph of the quadratic function    Translate the graph of horizontally by units.   If , then the translation is to the right.    If , then the translation is to the left.   This operation translates the vertex from to .    Scale the graph of by .   If , then the graph is stretched.    If , then the graph is compressed.   This operation fixes the vertex at .    If , reflect the graph of over the -axis. This operation fixed the vertex at .    Translate the graph of vertically by units.   If , then the translation is down.    If , then the translation is up.   This operation translates the vertex to .   This tells us a quadratic function in the form is a parabola with vertex at .    Completing the Square   Surprisingly, every quadratic function can be placed into vertex form. Paired with the observations above, this tells us the graph of every quadratic function is a parabola. Placing a general quadratic function into vertex form will require the method of completing the square.   Remember that when we multiply two binomials, we must distribute. We can remember how to distribute using the mnemonic FOIL: F irst, O uter, I nner, L ast:   Multiplying binomials using the FOIL method.    If we use this method to multiply a binomial by itself, then we find the useful formula We call a quadratic function of the form a perfect square .  Perfect Square    Given a quadratic equation , we can use the formula to complete the square   Complete the Square  as follows.   Completing the Square  To complete the square with the quadratic function    Factor an from the first two terms to get   Add and subtract inside the parentheses to get   Factor the first three terms inside the parentheses as a perfect square   Distribute the through the sum          The number is the -coordinate of the vertex, and the number is the -coordinate of the vertex.   The Vertex Formula   Let be a quadratic function. The -coordinate of the vertex is and the -coordinate of the vertex is      The vertex formula tells us the vertex form of is      Find the vertex form of the quadratic function .    The -coordinate of the vertex is and the -coordinate of the vertex is Therefore the vertex form of the quadratic function                  Find the vertex of the quadratic function .    The -coordinate of the vertex is and the -coordinate of the vertex is   Therefore the vertex form of the quadratic function is                     "
},
{
  "id": "objectives-24",
  "level": "2",
...
},
{
  "id": "definition-49",
  "level": "2",
  "url": "sec-quadratic_functions.html#definition-49",
  "type": "Definition",
  "number": "4.1.2",
...
},
{
  ...
  "body": " The Vertex Formula   Let be a quadratic function. The -coordinate of the vertex is and the -coordinate of the vertex is    "
},
{
  "id": "remark-8",
  "level": "2",
  ...
  "number": "4.1.6",
  "title": "",
  "body": " The vertex formula tells us the vertex form of is   "
},
{
  "id": "example-49",
  "level": "2",
...
},
{
  "id": "def-discriminant",
  "level": "2",
  "url": "sec-quadratic_formula.html#def-discriminant",
  "type": "Definition",
  "number": "4.2.1",
...
},
{
  ...
  "level": "2",
  "url": "sec-quadratic_formula.html#quadratic_formula",
  "type": "Formula",
  "number": "4.2.2",
  "title": "The Quadratic Formula.",
...
},
{
  "id": "theorem-12",
  "level": "2",
  "url": "sec-quadratic_formula.html#theorem-12",
  "type": "Theorem",
  "number": "4.2.3",
...
{
  "id": "sec-graphing_quadratics",
  "level": "1",
  "url": "sec-graphing_quadratics.html",
  "type": "Section",
  "number": "4.3",
  "title": "Graphing Quadratic Functions",
  "body": " Graphing Quadratic Functions    Find the line of symmetry of a quadratic functions.  Graph a quadratic function.     Line of Symmetry     "
},
{
  "id": "objectives-26",
  "level": "2",
  "url": "sec-graphing_quadratics.html#objectives-26",
  "type": "Objectives",
  "number": "4.3",
  "title": "",
  "body": "  Find the line of symmetry of a quadratic functions.  Graph a quadratic function.   "
},
{
  "id": "ch-equations",
  "level": "1",
  "url": "ch-equations.html",
  "type": "Chapter",
  "number": "5",
  "title": "Equations and Inequalities in Two Variables",
  "body": " Equations and Inequalities in Two Variables   In this chapter, we study equations and inequalities in two variables and their graphical representations in the Cartesian plane.    "
},
{
  "id": "appendix-1",
  "level": "1",
...
},
{
  "id": "fig-line",
  "level": "2",
  "url": "subsection-22.html#fig-line",
  "type": "Figure",
  "number": "B.1.1",
...
},
{
  "id": "fig-parabola",
  "level": "2",
  "url": "subsection-22.html#fig-parabola",
  "type": "Figure",
  "number": "B.1.2",
...
},
{
  "id": "fig-cubic",
  "level": "2",
  "url": "subsection-22.html#fig-cubic",
  "type": "Figure",
  "number": "B.1.3",
...
},
{
  "id": "fig-quartic",
  "level": "2",
  "url": "subsection-22.html#fig-quartic",
  "type": "Figure",
  "number": "B.1.4",
...
},
{
  "id": "fig-quintic",
  "level": "2",
  "url": "subsection-22.html#fig-quintic",
  "type": "Figure",
  "number": "B.1.5",
...
},
{
  "id": "fig-sq_root",
  "level": "2",
  "url": "subsection-23.html#fig-sq_root",
  "type": "Figure",
  "number": "B.2.6",
...
},
{
  "id": "fig-cube_root",
  "level": "2",
  "url": "subsection-23.html#fig-cube_root",
  "type": "Figure",
  "number": "B.2.7",
...
},
{
  "id": "fig-fourth_root",
  "level": "2",
  "url": "subsection-23.html#fig-fourth_root",
  "type": "Figure",
  "number": "B.2.8",
...
},
{
  "id": "fig-fifth_root",
  "level": "2",
  "url": "subsection-23.html#fig-fifth_root",
  "type": "Figure",
  "number": "B.2.9",
...
},
{
  "id": "fig-1_x",
  "level": "2",
  "url": "subsection-24.html#fig-1_x",
  "type": "Figure",
  "number": "B.3.10",
...
},
{
  "id": "fig-1_x_2",
  "level": "2",
  "url": "subsection-24.html#fig-1_x_2",
  "type": "Figure",
  "number": "B.3.11",
...
},
{
  "id": "fig-1_x_3",
  "level": "2",
  "url": "subsection-24.html#fig-1_x_3",
  "type": "Figure",
  "number": "B.3.12",
...
},
{
  "id": "fig-1_x_4",
  "level": "2",
  "url": "subsection-24.html#fig-1_x_4",
  "type": "Figure",
  "number": "B.3.13",
...
},
{
  "id": "fig-1_x_5",
  "level": "2",
  "url": "subsection-24.html#fig-1_x_5",
  "type": "Figure",
  "number": "B.3.14",
...
},
{
  "id": "fig-abs_val",
  "level": "2",
  "url": "subsection-25.html#fig-abs_val",
  "type": "Figure",
  "number": "B.4.15",
